...
Pipeline:
  ...
  5. Save fine-tuned weights to disk.
...
def main():
    ...
    if acc_before < 60.0:
        ...
        save_path = "pde_transformer_diffusion_finetuned.pth"
        torch.save(model.state_dict(), save_path)
        print(f"Saved fine-tuned model weights to: {os.path.abspath(save_path)}")
    else:
